...
primes = SieveOfEratosthenes(1000) #change 1000 to higher order numbers, slower but better.
...
for character in message:
	temp = ord(character)
	encrypted = encrypt(temp,n,e)
	print character, temp, encrypted , decrypt(encrypted,n,d)
