...
# This file was *autogenerated* from the file daedalus.sage
...
class Daedalus():
	...
	def loadpubkey(self, args, option):
		if(option == "file"):
			...
			self.n = args[_sage_const_0 ]
			self.e = args[_sage_const_1 ]
...
Common Modulus		      common_mod
			...
			try:
				...
				print "Unexpected error", sys.exc_info()[_sage_const_0 ], sys.exc_info()[_sage_const_1 ]
				print "Wrong Usage"
